...
import com.in.cafe.utils.EmilUtils;
...
public class UserServiceImpl implements UserService {
	...
	public ResponseEntity<String> signUp(Map<String, String> requestMap) {
		...
		try {
			if(validateSignUpMap(requestMap)) {
				...
				return CafeUtils.getResponseEntity(CafeConstents.INVALTD_DATA, HttpStatus.BAD_REQUEST);
			}
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public ResponseEntity<String> update(Map<String, String> requestMap) {
		...
		return new ResponseEntity<>(CafeConstents.SOMETETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
	}
		...
		try{
			...
			if(!userObj.equals(null)){
				if(userObj.getPassword().equals(requestMap.get("oldPassword"))){
					...
					return CafeUtils.getResponseEntity("Old password is not correct.", HttpStatus.BAD_REQUEST);
			}
			return CafeUtils.getResponseEntity(CafeConstents.SOMETETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
